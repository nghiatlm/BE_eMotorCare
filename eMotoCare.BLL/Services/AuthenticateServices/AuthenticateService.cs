    ...
    public class AuthenticateService : IAuthenticateService
    {
        ...
        public async Task<bool> Register(RegisterRequest request)
        {
            try
            {
                ...
                {
                    _logger.LogWarning("Không thể tạo tài khoản, số điện thoại {Phone} đã tồn tại.", request.Phone);
                ...
                _logger.LogInformation("Tạo tài khoản mới thành công với số điện thoại {Phone}, Role: {Role}", request.Phone, account.Role);
                return true;
