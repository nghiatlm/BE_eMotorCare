...
namespace eMotoCare.DAL.Migrations
{
    ...
    [Migration("20251209175923_updateDatabaseV10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eMotoCare.BO.Entities.EVCheckDetail", b =>
                {
                    ...
                    b.Property<Guid?>("ProgramDetailId")
                        .HasColumnType("char(36)")
                        .HasColumnName("campaign_detail_id");

                    b.Property<Guid?>("ProposedReplacePartId")
                        .HasColumnType("char(36)")
                        .HasColumnName("proposed_replace_part_id");
                    ...
                    b.HasIndex("ProposedReplacePartId");
            ...
            modelBuilder.Entity("eMotoCare.BO.Entities.ModelPart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                        .HasColumnName("model_part_id");
            ...
            modelBuilder.Entity("eMotoCare.BO.Entities.PartItem", b =>
                {
                    ...
                    b.Property<bool?>("IsManufacturerWarranty")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("is_manufacturer_warranty");
            ...
            modelBuilder.Entity("eMotoCare.BO.Entities.ProgramDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.Property<string>("RecallAction")
                        .HasColumnType("longtext")
                        .HasColumnName("recall_action");

                    b.Property<Guid?>("RecallPartId")
                        .HasColumnType("char(36)")
                        .HasColumnName("part_id");
            ...
            modelBuilder.Entity("eMotoCare.BO.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("eMotoCare.BO.Entities.Program", "Campaign")
                        .WithMany()
            ...
            modelBuilder.Entity("eMotoCare.BO.Entities.EVCheckDetail", b =>
                {
                    ...
                    b.HasOne("eMotoCare.BO.Entities.ProgramDetail", "CampaignDetail")
                        .WithMany()
                        .HasForeignKey("ProgramDetailId");

                    b.HasOne("eMotoCare.BO.Entities.Part", "ProposedReplacePart")
                        .WithOne("ProposedReplacePart")
                        .HasForeignKey("eMotoCare.BO.Entities.EVCheckDetail", "ProposedReplacePartId");
                    ...
                    b.Navigation("ProposedReplacePart");
                });
            ...
            modelBuilder.Entity("eMotoCare.BO.Entities.ExportNoteDetail", b =>
                {
                    ...
                    b.HasOne("eMotoCare.BO.Entities.Part", "ProposedReplacePart")
                        .WithMany()
                        .HasForeignKey("ProposedReplacePartId");
            ...
            modelBuilder.Entity("eMotoCare.BO.Entities.ProgramDetail", b =>
                {
                    ...
                    b.HasOne("eMotoCare.BO.Entities.Part", "RecallPart")
                        .WithMany("ProgramDetails")
                        .HasForeignKey("RecallPartId");
            ...
            modelBuilder.Entity("eMotoCare.BO.Entities.ServiceCenterInventory", b =>
                {
                    b.HasOne("eMotoCare.BO.Entities.ServiceCenter", "ServiceCenter")
                        ...
                        .HasForeignKey("eMotoCare.BO.Entities.ServiceCenterInventory", "ServiceCenterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
