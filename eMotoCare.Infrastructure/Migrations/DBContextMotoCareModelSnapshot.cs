...
namespace eMotoCare.Infrastructure.Migrations
{
    ...
    partial class DBContextMotoCareModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Account", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Appointment", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.BatteryCheck", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Branch", b =>
                {
                    b.Property<Guid>("BranchId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.BranchInventory", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.BranchInventoryExport", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Campaign", b =>
                {
                    b.Property<Guid>("CampaignId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.CampaignDetail", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Customer", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.EVCheck", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.EVCheckDetail", b =>
                {
                    b.Property<Guid>("EVCheckDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.ExportNote", b =>
                {
                    b.Property<Guid>("ExportNoteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.ImportNote", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.MaintenaceStage", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.MaintenaceStageDetail", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.MaintenancePlan", b =>
                {
                    b.Property<Guid>("MaintenancePlanId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Model", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.ModelPartType", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Part", b =>
                {
                    b.Property<Guid>("PartId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.PartItem", b =>
                {
                    b.Property<Guid>("PartItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.PartType", b =>
                {
                    b.Property<Guid>("PartTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Payment", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.PriceService", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.RMA", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.RMADetail", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.ServiceCenter", b =>
                {
                    b.Property<Guid>("ServiceCenterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Staff", b =>
                {
                    b.Property<Guid>("StaffId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Vehicle", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.VehiclePartItem", b =>
                {
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.VehicleStage", b =>
                {
                    b.Property<Guid>("VehicleStageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Account", b =>
                {
                    b.HasOne("eMotoCare.Domain.Entities.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId");

                    b.HasOne("eMotoCare.Domain.Entities.Staff", "Staff")
                        .WithMany()
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Appointment", b =>
                {
                    b.HasOne("eMotoCare.Domain.Entities.Staff", "ApproveBy")
                        .WithMany("Appointments")
                        .HasForeignKey("ApproveById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eMotoCare.Domain.Entities.Branch", "Branch")
                        .WithMany("Appointments")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eMotoCare.Domain.Entities.Campaign", "Campaign")
                        .WithMany("Appointments")
                    ...
                    b.HasOne("eMotoCare.Domain.Entities.VehicleStage", "VehicleStage")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.BatteryCheck", b =>
                {
                    b.HasOne("eMotoCare.Domain.Entities.EVCheckDetail", "EVCheckDetail")
                        .WithMany()
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Branch", b =>
                {
                    b.HasOne("eMotoCare.Domain.Entities.Staff", "ManageBy")
                        .WithOne()
                        .HasForeignKey("eMotoCare.Domain.Entities.Branch", "ManageById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eMotoCare.Domain.Entities.ServiceCenter", "ServiceCenter")
                        .WithMany("Branches")
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.BranchInventoryExport", b =>
                {
                    b.HasOne("eMotoCare.Domain.Entities.BranchInventory", "BranchInventory")
                        .WithMany("BranchInventoryExports")
                        .HasForeignKey("BranchInventoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eMotoCare.Domain.Entities.ExportNote", "ExportNote")
                        .WithMany("BranchInventoryExports")
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.CampaignDetail", b =>
                {
                    ...
                    b.HasOne("eMotoCare.Domain.Entities.Part", "Part")
                        .WithMany("CampaignDetails")
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.EVCheck", b =>
                {
                    b.HasOne("eMotoCare.Domain.Entities.Appointment", "Appointment")
                        .WithMany()
                        .HasForeignKey("AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eMotoCare.Domain.Entities.Staff", "TaskExecutor")
                        .WithMany("EVChecks")
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.EVCheckDetail", b =>
                {
                    b.HasOne("eMotoCare.Domain.Entities.EVCheck", "EVCheck")
                        .WithMany("EVCheckDetails")
                        .HasForeignKey("EVCheckId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eMotoCare.Domain.Entities.PartItem", "PartItem")
                        .WithMany("EVCheckDetails")
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.MaintenaceStage", b =>
                {
                    b.HasOne("eMotoCare.Domain.Entities.MaintenancePlan", "MaintenancePlan")
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.MaintenaceStageDetail", b =>
                {
                    b.HasOne("eMotoCare.Domain.Entities.MaintenaceStage", "MaintenaceStage")
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.ModelPartType", b =>
                {
                    b.HasOne("eMotoCare.Domain.Entities.Model", "Model")
                        .WithMany("ModelPartTypes")
                        .HasForeignKey("ModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eMotoCare.Domain.Entities.PartType", "PartType")
                        .WithMany("ModelPartTypes")
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.PartItem", b =>
                {
                    ...
                    b.HasOne("eMotoCare.Domain.Entities.ImportNote", "ImportNote")
                        .WithMany("PartItems")
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("eMotoCare.Domain.Entities.Customer", "Payer")
                        .WithMany()
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.RMA", b =>
                {
                    b.HasOne("eMotoCare.Domain.Entities.Staff", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.RMADetail", b =>
                {
                    ...
                    b.HasOne("eMotoCare.Domain.Entities.RMA", "RMA")
                        .WithMany("RMADetails")
                        .HasForeignKey("RMAId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.VehiclePartItem", b =>
                {
                    ...
                    b.HasOne("eMotoCare.Domain.Entities.PartItem", "ReplaceFor")
                        .WithMany()
                        .HasForeignKey("ReplaceForId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("eMotoCare.Domain.Entities.Vehicle", "Vehicle")
                        .WithMany("VehiclePartItems")
            ...
            modelBuilder.Entity("eMotoCare.Domain.Entities.VehicleStage", b =>
                {
                    b.HasOne("eMotoCare.Domain.Entities.MaintenaceStageDetail", "MaintenanceStageDetail")
